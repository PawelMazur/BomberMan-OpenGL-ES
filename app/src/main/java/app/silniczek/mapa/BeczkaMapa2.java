 ...
 */
public class BeczkaMapa2 extends EnemyMapa implements Bron {

    private String ZNACZNIK = "BeczkaMapa : ";
    private GL10 gl10;
    ...
    public BeczkaMapa2(GL10 gl10, int nrKolumny, int nrWiersza, int[] tekstura1, int[] tekstura2) {
        this.gl10 = gl10;
    ...
    public void tworzenieMapy() {
        if (!brick.isDestroy){
            ...
            brick.posX = nrKolumny * 0.1f + positionX;
            if (brick.posY - 0.01f < 0.8) {
                brick.posY = nrWiersza * 0.1f + positionY;
            }
