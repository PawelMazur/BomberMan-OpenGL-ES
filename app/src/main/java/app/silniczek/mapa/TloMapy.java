...
/**
 * Created by Pawel on 23.11.14.
 */
public class TloMapy extends GlownaMapa {
    ...
    public TloMapy(GL10 gl10, int nrKolumny, int nrWiersza, int[] tekstura1, int[] tekstura2) {
        this.gl10 = gl10;
